...
export const products: Product[] = [
	...
	},
	{
		...
		images: [
			...
			{ type: 'back', src: '/products/IDNR13/produkt7_deck_starRW_back.webp', alt: 'Deck Star RW – Ansicht' },
			{ type: 'closeup', src: '/products/IDNR13/produkt7_deck_starRW_closeup.webp', alt: 'Deck Star RW – Detail' },
		],
	...
	},
	{
		...
		images: [
			...
			{ type: 'back', src: '/products/IDNR22/produkt11_beanistar_black_back.webp', alt: 'Beanie Star Schwarz – Rückansicht' },
			{ type: 'closeup', src: '/products/IDNR22/produkt11_beanistar_black_closeup.webp', alt: 'Beanie Star Schwarz – Detail' },
		],
	...
	},
	{
		...
		images: [
			...
			{ type: 'back', src: '/products/IDNR23/produkt11_beanistar_blue_back.webp', alt: 'Beanie Star Blau – Rückansicht' },
			{ type: 'closeup', src: '/products/IDNR23/produkt11_beanistar_blue_closeup.webp', alt: 'Beanie Star Blau – Detail' },
		],
	...
	},
	{
		...
		images: [
			...
			{ type: 'modell', src: '/products/IDNR24/produkt12_shirt_blue_modell.webp', alt: 'Shirt DRK BW – Ansicht' },
		],
	...
	},
	{
		...
		price: 14,
		images: [
			{ type: 'front', src: '/products/IDNR25/produkt13_socks_black.webp', alt: 'Crew Sock Star Schwarz – Ansicht' },
			{ type: 'closeup', src: '/products/IDNR25/produkt13_socks_black_closeup.webp', alt: 'Crew Sock Star Schwarz – Detail' },
		],
	...
	},
	{
		id: 'IDNR26',
		category: 'accessories',
		title: 'CREW SOCK STAR GREY',
		price: 14,
		images: [
			{ type: 'front', src: '/products/IDNR26/produkt14_socks_grey.webp', alt: 'Crew Sock Star Grau – Ansicht' },
			{ type: 'closeup', src: '/products/IDNR26/produkt14_socks_closeup.webp', alt: 'Crew Sock Star Grau – Detail' },
		],
	...
	},
	{
		id: 'IDNR27',
		category: 'accessories',
		title: 'CREW SOCK STAR WHITE',
		price: 14,
		images: [
			{ type: 'front', src: '/products/IDNR27/produkt15_socks_white.webp', alt: 'Crew Sock Star Weiß – Ansicht' },
			{ type: 'closeup', src: '/products/IDNR27/produkt15_socks_closeup.webp', alt: 'Crew Sock Star Weiß – Detail' },
		],
